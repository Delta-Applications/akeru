  ...
  CheckDialogHelper.prototype = {
    ...
    _show: function(parent) {
      ...
      wrapper.innerHTML =
          ...
          '<input type="checkbox" id="group-check-enable" class="group-check-input">' +
          '</div>' +
          '</gaia-confirm>';
    ...
    handleEvent: function(e) {
      ...
      switch (e.type) {
        case 'hashchange':
          ...
          break;
        case 'confirm':
          Utils.setSettingsValue({ 'ril.mms.groupAlert.notshow': checkbox.checked });
          this.destroy();
        ...
        case 'accept':
          ...
          let checkChange = checkbox.checked ? 'deselect' : 'select';
          let softKeyParam = {
            "menuClassName":"menu-button",
            "header":{},
            "items":[{
