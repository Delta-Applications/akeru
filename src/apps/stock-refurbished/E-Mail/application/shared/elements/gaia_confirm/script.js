...
window.GaiaConfirm = (function(win) {
  ...
  */
  ...
  proto.createdCallback = function() {
    ...
    function _handleKDEvent(e) {
      switch(e.key) {
        case 'BrowserBack':
        case 'Backspace':
          SoftkeyHelper.hide();
          _self.dispatchEvent(new CustomEvent('cancel'));
          e.preventDefault();
          break;
      }
    }
    // handle center event
    function _handleCenterEvent(e) {
      switch(e.key) {
        case 'Accept':
          SoftkeyHelper.hide();
          _self.dispatchEvent(new CustomEvent('confirm'));
          e.preventDefault();
          break;
          default:
          break;
  ...
  template.innerHTML = `<div class="container"><form role="dialog" class="confirm">
      <section>
