 ...
 */
define('modules/dialog_manager',['require','modules/panel_cache'],function(require) {
      ...
      var promise = new Promise(function(resolve) {
        ...
        setTimeout(function() {
          if (method === 'open') {
            ...
            window.dispatchEvent(new CustomEvent('dialog-panel-transit'));
          } else {
    ...
    return SettingsPanel({
      ...
      onBeforeShow: function(panel) {
        if (!this._dialogPanelShow) {
          _initSoftKey();
          var wifiEnterCertPanel = document.getElementById('wifi-enterCertificateNickname');
          if (!wifiEnterCertPanel.classList.contains('current')) {
            this._cleanup();
        ...
        cursor.onsuccess = function() {
          ...
          if (file) {
            ...
            if (!list.querySelector('li')) {
              elements.noCertFiles.classList.remove('hidden');
      ...
      _createLinkAnchor: function(file) {
        ...
        anchor.onclick = () => {
          if (elements.wifiEnterCertPanelStatus) {
            return;
          }
          elements.wifiEnterCertPanelStatus = true;
              ...
              certRequest.onerror = () => {
                ...
                var dialogConfig = {
                  ...
                  accept: {
                    ...
                    priority: 2,
                    callback: function() {
                      self._setCertificateItemsEnabled(true);
                      setTimeout(function() {
      ...
      _isCertificateFile: function(extension) {
        var cerExtension = ['cer', 'crt', 'pem', 'der', 'p12', 'pfx'];
