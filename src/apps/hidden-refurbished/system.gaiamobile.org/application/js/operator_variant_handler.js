...
(function(exports) {
  ...
  var APN_TYPES = ['default', 'mms', 'supl', 'dun', 'ims', 'ia', 'hipri', 'xcap'];
  ...
  OperatorVariantHandler.prototype = {
    ...
    saveDefaultApnSettings:
      function ovh_saveDefaultApnSettings(apnSettings, allApnSettings) {
        ...
        request.onsuccess = (() => {
          ...
          transaction.set({
            'ril.data.apnSettings': allResult,
            'apn.selections': null
          });
    ...
    retrieveWAPUserAgentProfileSettings:
      ...
      console.log('operator_variant_handler system, retrieveWAPUserAgentProfileSettings');
