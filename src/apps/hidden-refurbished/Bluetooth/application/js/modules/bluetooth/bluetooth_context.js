 ...
 */
define(['require','modules/bluetooth/bluetooth_adapter_manager','modules/bluetooth/bluetooth_device','modules/mvvm/observable','modules/mvvm/observable_array'],function(require) {
  ...
  var BluetoothContext = {
    ...
    startDiscovery: function btc_startDiscovery() {
      ...
      //scan timeout is 12 ~ 40 seconds according the UI SPEC(bug 46209)
      setTimeout(() => { this.stopDiscovery(); }, SCANTIMEOUT);
    ...
    /**
     * refresh paired devices list which is maintained in BluetoothContext.
     *
     * @access public
     * @memberOf BluetoothContext
     */
    refreshPairedDevices: function btc_refreshPairedDevices() {
      if(this._defaultAdapter) {
        this._refreshPairedDevicesInfo(this._defaultAdapter);
      }
    },
